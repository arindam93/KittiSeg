...
test_img_path = 'RUNS/crackSeg_2018_12_03_23.50/test_images/'
...
for img_name, gt_name in zip(test_imgs_names, gt_imgs_names):
    ...
    cv2.imwrite(binary_img_path, img)
...
print('avg score: {}'.format(avg / float(num)))
print('avg pixel diff pct: {}'.format(avg_pixel_diff_pct / float(num)))
